...
export function Experience() {
  ...
  return (
    <section id="experience" className="py-24 bg-white dark:bg-slate-900 border-t border-slate-100
        ...
        <div className="space-y-16">
          {experiences.map((exp, index) => (
            <motion.div 
              ...
              className="relative"
            >
              <div className="flex flex-col md:flex-row md:items-baseline justify-between mb-4 border-b
               border-slate-200 dark:border-slate-800 pb-2">
                <div>
                  ...
                  <h4 className="text-slate-600 dark:text-slate-400 font-medium ml-4 mt-1">{exp.company}</h4>
                </div>
                <div className="mt-1 md:mt-0 ml-4 text-sm text-slate-500 dark:text-slate-500 font-mono bg-slate-100
              ...
              <ul className="space-y-3 mt-4 list-none ml-4">
                {exp.points.map((point, i) => (
                  <li key={i} className="text-slate-600 dark:text-slate-400 leading-relaxed pl-2 border-l-2
