    ...
    <section id="about" className="py-24 bg-white dark:bg-slate-900 border-t border-slate-100 dark:border-slate-800">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 p-8 md:p-12 
          rounded-2xl shadow-sm text-slate-600 dark:text-slate-300 text-lg leading-relaxed">
            <p className="mb-6">
              I'm a dedicated BCA student with a strong foundation in modern web development. Currently studying at
               Prime College (Tribhuvan University), I spend my time bridging the gap between design and robust engineering.
            </p>
            <p className="mb-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-4 gap-6 pt-8 border-t border-slate-200 dark:border-slate-700">
              ...
              <div>
                <span className="block text-base font-semibold text-slate-900 dark:text-white mb-1">Education</span>
                <span className="text-base">BCA, Prime College</span>
              </div>
              <div>
                <span className="block text-base font-semibold text-slate-900 dark:text-white mb-1">Email</span>
                <span className="text-base text-amber-600 dark:text-amber-400">Roshik9841@gmail.com</span>
              </div>
              <div>
                <span className="block text-base font-semibold text-slate-900 dark:text-white mb-1">Availability</span>
                <span className="text-base text-emerald-600 dark:text-emerald-400 font-medium">Open to work</span>
              </div>
            </div>
          </div>
        </motion.div>
